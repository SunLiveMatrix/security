...
var DEFAULT_MAX_DATE = datePickerUtils_1.DatePickerUtils.getDefaultMaxDate();
var DEFAULT_MIN_DATE = datePickerUtils_1.DatePickerUtils.getDefaultMinDate();
/**
 ...
 */
exports.DateInput = React.memo(function _DateInput(props) {
    var _a, _b, _c, _d, _e;
    ...
    _g = props.maxDate, 
    // defaults duplicated here for TypeScript convenience
    maxDate = _g === void 0 ? DEFAULT_MAX_DATE : _g, _h = props.minDate, minDate = _h === void 0 ? DEFAULT_MIN_DATE : _h, placeholder = props.placeholder, _j = props.popoverProps, popoverProps = _j === void 0 ? {} : _j, popoverRef = props.popoverRef, showTimezoneSelect = props.showTimezoneSelect, timePrecision = props.timePrecision, timezone = props.timezone, value = props.value, datePickerProps = tslib_1.__rest(props, ["defaultTimezone", "defaultValue", "disableTimezoneSelect", "fill", "inputProps", "maxDate", "minDate", "placeholder", "popoverProps", "popoverRef", "showTimezoneSelect", "timePrecision", "timezone", "value"]);
    // Refs
    // ------------------------------------------------------------------------
    ...
    var formattedDateString = React.useMemo(function () {
        return valueAsDate === null ? undefined : (0, dateFormatProps_1.getFormattedDateString)(valueAsDate, props);
    }, [
        valueAsDate,
        minDate,
        maxDate,
    ...
    React.useEffect(function () {
        ...
        if (defaultTimezone !== undefined && (0, timezoneNameUtils_1.isValidTimezone)(defaultTimezone)) {
            setTimezoneValue(defaultTimezone);
        }
    }, [defaultTimezone]);
    React.useEffect(function () {
        // controlled mode, updating timezone value
        if (timezone !== undefined && (0, timezoneNameUtils_1.isValidTimezone)(timezone)) {
    ...
    var handleDateChange = React.useCallback(function (newDate, isUserChange, didSubmitWithEnter) {
        ...
        var newIsOpen = !isUserChange ||
            ...
            (prevDate != null &&
                ((0, dateUtils_1.hasMonthChanged)(prevDate, newDate) ||
                    (timePrecision !== undefined && (0, dateUtils_1.hasTimeChanged)(prevDate, newDate))));
        ...
        if (isControlled) {
            ...
            var newFormattedDateString = (0, dateFormatProps_1.getFormattedDateString)(newDate, props);
            setIsInputFocused(newIsInputFocused);
            setIsOpen(newIsOpen);
            setValue(newDate);
    ...
    var popoverContent = (React.createElement("div", { ref: popoverContentRef, role: "dialog", "aria-label": "date picker", id: popoverId },
        ...
        React.createElement(datePicker_1.DatePicker, tslib_1.__assign({}, datePickerProps, { dayPickerProps: dayPickerProps, maxDate: maxDate, minDate: minDate, onChange: handleDateChange, onShortcutChange: handleShortcutChange, selectedShortcutIndex: selectedShortcutIndex, timePrecision: timePrecision, 
    ...
    var maybeTimezonePicker = isTimezoneSelectHidden ? undefined : (React.createElement(timezoneSelect_1.TimezoneSelect, { buttonProps: timezoneSelectButtonProps, className: common_1.Classes.DATE_INPUT_TIMEZONE_SELECT, date: tzSelectDate, disabled: isTimezoneSelectDisabled, onChange: handleTimezoneChange, value: timezoneValue },
        React.createElement(core_1.Tag, { interactive: !isTimezoneSelectDisabled, minimal: true, rightIcon: isTimezoneSelectDisabled ? undefined : "caret-down" }, (0, timezoneNameUtils_1.getTimezoneShortName)(timezoneValue, tzSelectDate))));
    // Text input
    // ------------------------------------------------------------------------
    ...
    return (React.createElement(core_1.Popover, tslib_1.__assign({ isOpen: isOpen && !props.disabled }, popoverProps, { autoFocus: false, className: (0, classnames_1.default)(common_1.Classes.DATE_INPUT, popoverProps.className, props.className), content: popoverContent, enforceFocus: false, onClose: handlePopoverClose, popoverClassName: (0, classnames_1.default)(common_1.Classes.DATE_INPUT_POPOVER, popoverProps.popoverClassName), ref: popoverRef, renderTarget: renderTarget })));
});
exports.DateInput.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".DateInput");
...
function getInitialTimezoneValue(_a) {
    ...
    if (timezone !== undefined) {
        // controlled mode
        if ((0, timezoneNameUtils_1.isValidTimezone)(timezone)) {
            return timezone;
        }
        else {
            console.error(Errors.DATEINPUT_INVALID_TIMEZONE);
            return timezoneItems_1.UTC_TIME.ianaCode;
        }
    }
    else if (defaultTimezone !== undefined) {
        // uncontrolled mode with initial value
        if ((0, timezoneNameUtils_1.isValidTimezone)(defaultTimezone)) {
        ...
        // uncontrolled mode
        return (0, getTimezone_1.getCurrentTimezone)();
    }
}
